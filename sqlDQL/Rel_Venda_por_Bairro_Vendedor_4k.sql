-- Vendas Detalhada em Bairros de Vendedores tendo vendas acima de 4000.
select
...
group by
    INF.NUMERO, TDC.NOME, TDV.NOME, TDC.BAIRRO, TDP.CODIGO_DO_PRODUTO,
    TDP.NOME_DO_PRODUTO, INF.QUANTIDADE, INF.PRECO, NF.IMPOSTO
having
    sum(round((INF.QUANTIDADE * INF.PRECO), 2)) >= 4000
order by
    TOTAL desc;
